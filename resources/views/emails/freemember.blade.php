                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="510" class="flexibleContainer" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td align="center" valign="top" width="510" class="flexibleContainer">
                                                                <p class="p_bashkerville"  style="line-height: 1.5em; letter-spacing: 1px; margin:0px; padding:0px; font-family: 'Baskerville', Arial, Helvetica; font-weight:normal; font-size: 20px; color:#333333;">Thank you for signing up for a free account with Ojolie. You can now send all our <a href="https://ojolie-frontend.vercel.app" style="color:#FF66CC; text-decoration: none;">our free cards</a>. To send all <a href="https://ojolie-frontend.vercel.app" style="color:#FF66CC; text-decoration: none;">our other cards</a>, please upgrade to a <a href="https://ojolie-frontend.vercel.app" style="color:#FF66CC; text-decoration: none;">premium membership</a>..</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
