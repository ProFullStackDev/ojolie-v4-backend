...
<div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        {{Form::model($ecardcategory,['route'=>['ecardcategories.update',$ecardcategory->id],'method'=>'put','files'=>true])}}
        <div class="row">
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                @if($ecardcategory->header_image == null)
                No Header Image
                @elseif($ecardcategory->header_image != null)
                <img src="{{asset('storage/img/headers/'.$ecardcategory->header_image)}}" alt="Header Image" class="img-responsive thumbnail" id="header_image_display" />
                @endif
