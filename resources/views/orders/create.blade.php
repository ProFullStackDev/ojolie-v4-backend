...
<div class="modal-header">
    ...
    <h4 class="modal-title">Order/Payment Create</h4>
</div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {{Form::select('subscription_type',$subscription_types,null,['class'=>'form-control','required'])}}
            </div>
            <div class="form-group">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {{Form::select('pay_status',$payment_status,null,['class'=>'form-control','required'])}}
            </div>
            <div class="form-group">
